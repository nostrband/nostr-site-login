  ...
  private renderForm() {
    return html` <form class="ns_email_form" @submit=${this._handleSubmit}>
      <div class="ns_email_field_container">
        ...
        <input style="--accentColor: ${this.accentColor};" class="ns_email_input focus:border-[var(--accentColor)]" type="email" id="ns-email-field" placeholder="E-mail or Nostr address" />
      </div>
      <button class="ns_email_submit" style="color: ${this.textColor}; background-color: ${this.accentColor}" type"submit">Sign in</button>
